<?php
	...
	$query="INSERT INTO `talleres`(`codigo`, `nombre`, `costo`, `cupos`) VALUES ('$codigo','$nombre',$costo,$cupos)";

	$result = mysqli_query($link, $query) or die('error de sql');

	$query2 = "select max(id) from talleres talleres";
	...
	echo '<script>alert("Taller guardado")</script>';
